...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        // Profile Picture
        ImageIcon img_Icon = new ImageIcon(ClassLoader.getSystemResource("icons\\dp1.png"));
        ...
        AudioCall.setBounds(371,15,30,25);
        ...
        threedot.setBounds(420,14,20,25);
        hedder_panel.add(threedot);
        
        // User name
        JLabel name = new JLabel("Alpha");
